...
public:
     ...
     */
    UFUNCTION(BlueprintCallable, meta = (Latent, LatentInfo = "LatentActionInfo", WorldContext = "WorldContextObject"))
...
public:
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "RuntimeAssetImport|Experimental")
    static UPARAM(DisplayName = "Root Static Mesh Component")
        UStaticMeshComponent *ConstructStaticMeshComponentFromMeshData(const FLoadedMeshData &MeshData,
...
public:
     ...
     */
    UFUNCTION(BlueprintCallable, meta = (ExpandEnumAsExecs = "ConstructProceduralMeshComponentFromAssetFileResult"))
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "RuntimeAssetImport|Experimental",
              meta = (ExpandEnumAsExecs = "ConstructStaticMeshComponentFromAssetFileResult"))
    static UPARAM(DisplayName = "Root Static Mesh Component")
     ...
     *          If the result is Failure, the return value is nullptr.
     */
    UFUNCTION(BlueprintCallable, meta = (ExpandEnumAsExecs = "ConstructDynamicMeshComponentFromAssetFileResult"))
    static UPARAM(DisplayName = "Root Dynamic Mesh Component")
